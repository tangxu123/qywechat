...
(function () {
    ...
    function Calender(opt) {
        ...
        var month_num_array = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"];
        ...
        function _drawCalenderDate(_this) {
            ...
            _this.container_element.getElementsByClassName('calendar-title')[0].innerHTML = selectedDate.getFullYear() + '年 ' + month_num_array[selectedDate.getMonth()] + '月';
            ...
            for (i = 0; i < 5; ++i) {
                for (j = 0; j < 7; ++j) {
                    ...
                    //temp_date.getFullYear() + "-" + temp_date.getMonth() + "-" + temp_date.getDate();
                    $(tempSpanElement).attr("data-date", tempThisMonthCalenderDate[k].getFullYear() + "-" + (tempThisMonthCalenderDate[k].getMonth() ) + "-" + tempThisMonthCalenderDate[k].getDate());
        ...
        function _setPostionAndHeight(_this, positionInfo) {
            if (positionInfo) {
                ...
                // alert(positionInfo.positonY);
                if(50<positionInfo.positonY*-1){
                    document.getElementById("content1").style.height='1000px';
                }else if('0'==positionInfo.positonY){
            ...
            _this.keyElement.date_container.style.height = _this.mode == 'week' ? _this.keyData.calenderHeight + 'px' : _this.keyData.calenderHeight * 5 + 'px';

            $("#content").height ( _this.mode == 'week' ? (200+ _this.keyData.calenderHeight*4) + 'px' :   '200px');
        ...
        function _initDateTouchAndAnimation(_this) {
            ...
            function _redrawCalenderDate() {
                _drawCalenderDate(_this);
                init(_this.dateSelectObject.getSelected().getFullYear(),_this.dateSelectObject.getSelected().getMonth()+1,_this.dateSelectObject.getSelected().getDate());
            }
            ...
            function handleDateClick(e) {
                ...
                var d = new Date();
                d.setTime(_this.dateSelectObject.getMonthCalenderDateTimeByIndex(dateIndex));
        ...
        function updateAnimate() {
            switch (s.params.pos) {
                ...
                case "top":
                    ...
                    break;
                case "bottom":
                    hideAnimate = {bottom: "-100%"};
                    showAnimate = {bottom: "0%"};
                    break;
                case "left":
                    hideAnimate = {left: "-100%"};
                    showAnimate = {left: "0%"};
                    break;
                case "right":
                    hideAnimate = {right: "-100%"};
                    showAnimate = {right: "0%"};
                    break;
                default :
                    s.params.pos = "middle";
