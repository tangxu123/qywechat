...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                ...
                if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min,
                    ...
                    if (t == this.baseValue && "radar" != a.type) {
                        ...
                        (f = this.zeroGridAlpha), f = d.line(a.container, D, C, this.gridColor, f, 1, this.dashLength), f.translate(this.x, this.y), this.grid0 = f, a.axesSet.push(f), f.toBack(), d.setCN(a, f, this.bcn + "zero-grid-" + this.id), d.setCN(a, f, this.bcn + "zero-grid"))
                    }
                    if (!isNaN(z) && 0 < A && g < r - 1) {
                        ...
                        for (H = 1; H < f; H++) {
                            var P = this.getCoordinate(t + z * H), P = new this.axisItemRenderer(this,
                                P, "", !1, 0, 0, !1, !1, 0, !0);
                            this.pushAxisItem(P)
                        }
                        this.gridAlpha = K
            ...
            this.maximumDate && (this.maximumDate instanceof Date ||
            (this.maximumDate = d.getDate(this.maximumDate, this.chart.dataDateFormat, "fff")), this.max = this.maximumDate.getTime())
        }, formatValue: function (a, b, c) {
            var e = this.exponential, h = this.logarithmic, f = this.numberFormatter, g = this.chart;
            if (f)return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c = Number(e[0]), e = Number(e[1]), c = d.roundTo(c, 14), b || isNaN(this.precision) ||
            ...
            if (r && ("regular" == b || "100%" == b))for (q = 0; q < k.length; q++)n = k[q], n.stackGraph = null, n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis ==
            ...
            this.logarithmic && (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)),
                this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10 < a && (this.minReal = this.min = 10 * a)))
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), R = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (K = g.lineColor), void 0 != g.color && (v = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (I = !0, 0 < ea && (ea = 0)), isNaN(g.labelRotation) ||
            ...
            var V = n * Math.PI / 180, Y, Da, G = 0, w = 0, na = 0, ha = Y = 0, Qa = 0;
            "V" == Pa && (n = 0);
            var ca;
            ...
            if ("H" == Pa) {
                ...
                1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), V = e - da, Da = d.polygon(y,
                    [0, a.width, a.width, 0], [0, 0, V, V], P, O), Da.translate(wa, e - V + ma), x.push(Da));
                w += r / 2;
            ...
            ca && (ca.attr({"text-anchor": ga}), ca.translate(G, w, NaN, !0), 0 !== n && ca.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, !0), g && d.setCN(p, ca, "guide"));
...
(function () {
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var wa = this.categoryAxis, ma = this.baseCoord, Pa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness, X = this.lineAlpha,
                Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ga = this.getGradRotation(), V = this.chart.columnSpacing, Y = wa.cellWidth, Da = (Y * k - r) / r;
            V > Da && (V = Da);
            var G, w, na, ha = q, Qa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Ra = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < R) {
                    ...
                    if (this.lineColorField)for (L =
                                                     R; -1 < L; L--)if (G = e[L], w = G.axes[f.id].graphs[b], w.lineColor) {
            ...
            for (L = R; L <= ia; L++) {
                ...
                var S, Q, J, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN,
                    pa = NaN, qa = NaN, ra = NaN, sa = NaN, xa = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Na = wb, Va = Ya, Ha = Aa, Ca, ya, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W))y || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []); else {
                                ...
                                if ($a || void 0 != w.lineColor && w.lineColor != this.lineColorSwitched || void 0 != w.fillColors && w.fillColors != this.fillColorsSwitched || !isNaN(w.dashLength))this.drawLineGraph(x, u, T, U), x = [E], u = [F], T = [], U = [], !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)), m ? Sa ? (this.lineColorSwitched = Aa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Ra) : (this.lineColorSwitched =
                                    w.lineColor, this.fillColorsSwitched = w.fillColors), this.dashLengthSwitched = w.dashLength;
                        ...
                        case "smoothedLine":
                            if (isNaN(W))y || (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = []); else {
                                ...
                                la = F;
                                !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M));
                                void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(x, u, T, U), x = [E], u = [F], T = [], U = [],
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (x.push(A), u.push(F - va)), u.push(F - va), x.push(E), u.push(F + Ga), x.push(E), !Ma || isNaN(M) || isNaN(N) || (isNaN(B) || (T.push(B), U.push(M - va)), T.push(N), U.push(M - va), T.push(N), U.push(M + Ga))) : (isNaN(z) || (u.push(z), x.push(E - va)), x.push(E - va), u.push(F),
                                    x.push(E + Ga), u.push(F), !Ma || isNaN(M) || isNaN(N) || (isNaN(D) || (T.push(N - va), U.push(D)), T.push(N - va), U.push(M), T.push(N + Ga), U.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                D = M;
                        ...
                        case "column":
                            ...
                            if (!isNaN(W)) {
                                ...
                                w.isNegative && (Ra && (Na = Ra), void 0 != Ja &&
                                (Ca = Ja));
                        ...
                        case "candlestick":
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (S < n && 0 < J) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, J, ba, H, P, Na, Va, da, Ca, X, ga, v, t, ea, bb, mb, aa), Gb, Hb;
                                ...
                                ua && (ya = ua.set, w.columnGraphics = ya, fa.push(ya),
                                    ya.translate(S, Q - da / 2), (w.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (w.x = t ? Q + J / 2 : S + J / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(ya, w), void 0 !== this.tabIndex && ya.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
                            if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                ...
                                if (t) {
                                    ...
                                    "high" == l && (la = sa);
                                    "low" == l && (la = qa);
                                    var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa,
                                        0, Fa), Kb = E - k / 2, Kb = d.fitToBounds(Kb, 0, n), Ub = d.fitToBounds(E, 0, n), Lb = E + k / 2, Lb = d.fitToBounds(Lb, 0, n);
            ...
            if (void 0 !== b && "" !== b)return a = d.text(this.container,
                b, h, e.fontFamily, c), a.node.style.pointerEvents = "none", d.setCN(e, a, this.bcn + "label"), this.bulletSet.push(a), a
                ...
                if (n.mouseIsOver) {
                    ...
                    if (this.resizingLeft) {
                        if (m)if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a)this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f); else {
                            ...
                            b ? c - e : l + c - e, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth, e = c), 0 > a)this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d); else {
                            if (0 === a || isNaN(a))a = .1;
                            g.setAttr("x", e - d);
                            g.setAttr("width", a)
                        }
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + v, m = D + r, O = this.shadowAlpha, R = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, I, v = this.fillAlpha, aa = this.borderAlpha;
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * v, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, K = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * v, H = {
