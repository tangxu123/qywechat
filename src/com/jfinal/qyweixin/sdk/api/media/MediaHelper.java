...
public class MediaHelper {
    public ApiResult send(String fileType, String fileName, InputStream inputStream) throws Exception {
        String result = null;
     ...
     * @throws Exception
     */
    public ApiResult send(String fileType, String filePath) throws Exception {
        String result = null;
