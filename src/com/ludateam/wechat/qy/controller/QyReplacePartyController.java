...
@Controller("/wechat/replaceparty")
public class QyReplacePartyController extends BaseController {
	
    private static final Log log = Log.getLog(QyReplacePartyController.class);
    ...
    public void index() {
        ...
        apiResult = ConBatchApi.batchReplaceParty("{\"media_id\":\"" + mediaId + "\"" + "}");
