...
@Controller("/wechat/qyoauth")
public class QyOAuthController extends ApiController {
    private static final Log log = Log.getLog(QyOAuthController.class);

    public void index() {
        try {
            String redirect_uri = URLEncoder.encode(PropKit.get("domain") + "/wechat/qyoauth/code", "utf-8");
