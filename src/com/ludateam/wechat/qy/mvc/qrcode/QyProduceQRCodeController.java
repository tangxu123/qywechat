...
@Controller("/wechat/vipnumber")
public class QyProduceQRCodeController extends BaseController {

    private static final Log log = Log.getLog(QyProduceQRCodeController.class);
    ...
    public void index() {
        try {
            String redirect_uri = URLEncoder.encode(PropKit.get("domain") + "/wechat/vipnumber/main", "utf-8");
